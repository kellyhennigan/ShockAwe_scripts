function B = glm_fmri_getRoiBetas_pluck(roiFiles,roiStrs,irf)
...
outDir = '/Users/Kelly/ShockAwe/data/betas';

cd(['/Users/Kelly/ShockAwe/data/results_',irf]);
...
for c=1:length(stims)
    ...
    for s = 1:length(subjects)
        ...
        for j = 1:nR
            ...
            roi = readFileNifti(['/Users/Kelly/ShockAwe/data/ROIs_tlrc/',roiFiles{j}]);
